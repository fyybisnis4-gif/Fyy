...
FreeButton.MouseButton1Click:Connect(function()
    ...
    ClickTween.Completed:Connect(function()
        ...
        local success, errorMessage = pcall(function()
           loadstring(game:HttpGet("https://raw.githubusercontent.com/fyywannafly-sudo/WalkOnly/refs/heads/main/arunika%20walkk"))()
        end)
...
PremButton.MouseButton1Click:Connect(function()
    ...
    ClickTween.Completed:Connect(function()
        ...
        -- Load script Premium
        local success, errorMessage = pcall(function()
            loadstring(game:HttpGet('https://raw.githubusercontent.com/fyybisnis4-gif/walkss/refs/heads/main/arunika%20tinggi.lua'))()
        end)
